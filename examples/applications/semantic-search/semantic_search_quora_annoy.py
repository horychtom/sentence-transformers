...
annoy_index_path = (
    "quora-embeddings-{}-size-{}-annoy_index-trees-{}.ann".format(
...
if not os.path.exists(annoy_index_path):
    # Create Annoy Index
    print(
        "Create Annoy index with {} trees. This can take some time.".format(
            n_trees,
        ),
    )
...
print(
    "Corpus loaded with {} sentences / embeddings".format(
...
while True:
    ...
    recall = len(ann_corpus_ids.intersection(correct_hits_ids)) / len(
        correct_hits_ids,
    )
    print(
